...
## Business Context (external communication partners)
...
### Persistence options (exactly one active per deployment)
...
### Summary of fundamental decisions
...
### Key quality goals → solution approaches
